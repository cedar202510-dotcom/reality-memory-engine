...
07 号文档 §7.4 明确反对把加密货币基础设施引入 Reality Memory 主体：
「方向与 Reality Memory 的信任叙事相反……**若真要做，做成独立产品线、独立 App、独立品牌**」。

**执行上**：独立分支、独立 README、与主产品只共享灵感数据导出接口。
不要把 Reality Memory 包装成区块链项目。
...
- 工作量是估算不是承诺，未经排期确认
- 本清单中的功能未进入 [PRD](../product/Reality-Memory-Engine-PRD-v1.3.md) 与
