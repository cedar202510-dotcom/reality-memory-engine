...
| 端云通信 | 眼镜、手机和云端如何交换数据 | 设备身份、上行 Evidence、下行消息、中继和回执 | [04 设备与云端通信](04-Device-Cloud-Communication.md) |
...
Runtime。任一具备 Android Studio、JDK 和 Gradle 环境的电脑都可以构建 APK；
持有开发线和 RV101 的电脑负责 ADB 安装、设备能力矩阵和采样回传。
