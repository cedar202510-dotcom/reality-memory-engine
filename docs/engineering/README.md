...
| 文档 | 用途 | 状态 |
| --- | --- | --- |
| [工程架构与数据链路 v1.3](RealGit-Engineering-Architecture-v1.3.md) | 从采集到记忆和提醒的完整工程解释 | 当前参考 |
| [多模态数据契约 v1.0](RealGit-Multimodal-Data-Contract-v1.0.md) | 对象语义、时间、来源、Evidence 和事实链 | 当前正式契约 |
